...
const config: Config = {
    ...
    plugins: [
        [
            ...
            {
                id: 'api', // Give the new docs instance a unique ID
                path: 'api-docs', // The directory where your API docs markdown files will live
                routeBasePath: 'api', // The base path for your API docs on the website
                sidebarPath: require.resolve('./sidebars-api.ts'), // The sidebar file for these docs
            },
        ],
        [
            '@docusaurus/plugin-content-docs',
    ...
    themeConfig: {
        ...
        navbar: {
            ...
            items: [
                ...
                { href: 'https://blog.haoyuehx.dpdns.org/', label: 'Blog', position: 'right' },
                {
